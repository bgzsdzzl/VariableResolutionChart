...
\- \*\*Bug or feature request?\*\* Use the \[issue templates](.github/ISSUE\_TEMPLATE).
...
Open the generated .sln, build the Development Editor configuration.



Launch the editor and enable the plugin under
...
in short: you wrote the code, or you have the right to submit it, and you

are granting the project the right to distribute it under its license.
...
Open an issue first if the change touches the public API or is

non-trivial. Agreeing on the approach before writing code saves everyone
...
Keep the PR focused. One logical change per PR. Do not bundle a
...
Use the Bug Report template. Titles
